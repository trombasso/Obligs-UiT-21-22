...
class Itinerary:
    ...
    def get_total_travel_time(self):
        ...
        for i in range(0, len(self.flights)):
            lis1 = self.flights[i]
            hour = lis1.departure_time.hour
            min = lis1.departure_time.minute
            sec = lis1.departure_time.second
        ...
        total_travel_time = latest_arrival - earliest_departure
...
def main():
    ...
    print(f"\nTotal travel time: {itinerary.get_total_travel_time()}")
